...
UBUNTU_18_PACKAGES="curl figlet toilet fortune cowsay texinfo jq"
...
sudo DEBIAN_FRONTEND=noninteractive \
    apt install \
    abootimg adb autoconf automake axel bc bison build-essential \
    ccache clang cmake expat fastboot flex g++ g++-multilib gawk \
    gcc gcc-multilib git gnupg gperf htop imagemagick lib32ncurses5-dev \
    lib32z1-dev libtinfo5 libc6-dev libcap-dev libexpat1-dev libgmp-dev \
    '^liblz4-.*' '^liblzma.*' libmpc-dev libmpfr-dev libncurses5-dev \
    libsdl1.2-dev libssl-dev libtool libxml2 libxml2-utils '^lzma.*' lzop \
    maven mkbootimg ncftp ncurses-dev patch patchelf pkg-config pngcrush \
    pngquant python2.7 python-all-dev re2c schedtool skales squashfs-tools subversion \
    texinfo unzip w3m xsltproc zip zlib1g-dev lzip libxml-simple-perl apt-utils \
    "${PACKAGES}" -y
